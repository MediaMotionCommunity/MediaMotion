...
public class MenuBehavior : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        _uiCam = _mainCam = (GameObject.Find("Cameras/Main") as GameObject).GetComponent(typeof(Camera)) as Camera;
    ...
    void Update()
    {
        //foreach (IAction Action in this._input.GetMovements())
        //{
        ...
        //                if (parentToFinger.magnitude < _activation_radius && (Action.Parameter as MediaMotion.Motion.Actions.Parameters.Cursor).Z > _deactivate_z)
        //                {
        ...
        //                if ((Action.Parameter as MediaMotion.Motion.Actions.Parameters.Cursor).Z < _deactivate_z)
        //                {
        //                    _selectionMade = false;
        //                    _scalingFactor = 1.0f;
        ...
        //                if (i == _currentSelection) { _buttons[i].renderer.material.color = Color.Lerp(_buttons[i].renderer.material.color, _selectedColor, 0.25f); } else { _buttons[i].renderer.material.color = Color.Lerp(_buttons[i].renderer.material.color, _baseColor, 0.25f); }
        //            }
        ...
        //                    if (_closest == _currentSelection) { _buttons[_closest].renderer.material.color = Color.Lerp(_selectedColor, _highlightColor, highlightPercent); } else { _buttons[_closest].renderer.material.color = Color.Lerp(_baseColor, _highlightColor, highlightPercent); }
